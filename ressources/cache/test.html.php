...
<form><label>login</label><input id='login'><br></br><label>password</label><input
            id='password'><?php echo "--> test"; ?><?php echo "--> test"; ?><?php echo "--> test"; ?><?php echo 'test2'; ?><?php echo 'test3'; ?><?php echo 'test2'; ?><?php echo 'test3'; ?><?php echo 'test2'; ?><?php echo 'test3'; ?><?php echo 'test2'; ?><?php echo 'test3'; ?><?php $foobar = array(0 => 'int:1', 1 => 'bool:true', 2 => 'str:3',);
    $barfoo = 'testdephp4';
